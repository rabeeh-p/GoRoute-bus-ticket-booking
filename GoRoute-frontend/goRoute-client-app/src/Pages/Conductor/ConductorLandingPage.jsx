    ...
    const fetchBusData = async () => {
      ...
      try {
        ...
        if (response.data) {
          ...
          setLoading(false);
          console.log(response.data, 'data init');
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center py-12">
      <div className="bg-white shadow-xl rounded-lg w-11/12 sm:w-3/4 lg:w-1/2 p-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-semibold text-blue-600">Welcome, Conductor!</h1>
        ...
        <div className="text-center">
          ...
          {loading ? (
            ...
            busData ? (
              ...
              <p className="text-lg text-gray-500">No bus scheduled at the moment. Please check back later.</p>
            )
          ) : (
            <p className="text-lg text-gray-500">You are not currently on duty. Please check back when on duty.</p>
          )}
        </div>
      </div>
    </div>
